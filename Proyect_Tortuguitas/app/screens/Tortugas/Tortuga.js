...
import CambioTamaño from "../../components/Tortugas/CambioTamaño";
...
export default function Tortuga(props) {
  ...
  return (
    <ScrollView style={styles.viewBody}>
      <Carousel arrayImages={imagesTortuga} width={screenWidth} height={250} />
...
function TortugaInfo(props) {
  ...
  return (
    <View style={styles.viewtortugaInfo}>
      <Text style={styles.tortugaInfoTitle}>Información sobre el tortuga</Text>
