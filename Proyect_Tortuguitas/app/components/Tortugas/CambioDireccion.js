...
export default function CambioDireccion(props) {
  const { id, dirección, setIsVisibleModal, setReloadData , toastRef} = props;
  ...
  return (
    <View style={styles.view}>
       <Input
        ...
        defaultValue={dirección && dirección}
